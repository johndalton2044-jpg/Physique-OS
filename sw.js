/* PHYSIQUE OS service worker — generated by build.mjs. Version 1.0.0+9173e3a664 */
var VERSION='physique-os-1.0.0-9173e3a664';
var SHELL=['./','./index.html','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png','./icons/apple-touch-icon.png','./data/reference/compendium-2024.json'];
